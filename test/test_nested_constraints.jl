...
@test 4 == LaSR.CheckConstraintsModule.count_max_nestedness(
...
@test 2 == LaSR.CheckConstraintsModule.count_max_nestedness(
...
@test !LaSR.CheckConstraintsModule.flag_illegal_nests(tree, options)
