...
for unaop in [cos, exp, safe_log, safe_log2, safe_log10, safe_sqrt, relu, gamma, safe_acosh]
    for binop in [sub]
        ...
        for T in types_to_test
            ...
            test_y2, complete2 = differentiable_eval_tree_array(tree, X, make_options().operators)
            ...
            test_dy = ForwardDiff.gradient(
                _x -> sum(differentiable_eval_tree_array(tree, _x, make_options().operators)[1]), X
            )
